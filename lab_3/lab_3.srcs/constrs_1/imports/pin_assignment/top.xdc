...
########################################
## HEX DISPLAY A (Left 4 digits)
########################################
set_property IOSTANDARD LVCMOS25 [get_ports {hex_grid_a[*]}]
set_property IOSTANDARD LVCMOS25 [get_ports {hex_seg_a[*]}]
...
########################################
## HEX DISPLAY B (Right 4 digits)
########################################
set_property IOSTANDARD LVCMOS25 [get_ports {hex_grid_b[*]}]
set_property IOSTANDARD LVCMOS25 [get_ports {hex_seg_b[*]}]
